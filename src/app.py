...
from models import save_contact, save_cart, get_cart
from db import mongo

app = Flask(__name__)
app.secret_key = 'a44a55a0470aecd2d9dfc27f701bb8a2'
app.config["MONGO_URI"] = "mongodb+srv://12subratpandey:f08DLSNuuOBCn62J@cluster0.uoeorft.mongodb.net/pizzaapp?retryWrites=true&w=majority&appName=Cluster0"
...
def cart():
    username = session['user']
    db_cart = get_cart(username)
    cart_ids = db_cart["cart"] if db_cart and "cart" in db_cart else []
